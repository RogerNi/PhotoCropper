...
OUTPUT_DIR = '/home/mars/Documents/Test_Output'
ZOOM_RATIO = 1.08
WINDOW_WIDTH = 1024
WINDOW_HEIGHT = 768
CROP_SIZE = (122, 122)
...
def printWheel(event):
    print('Mouse Wheel: '+str(event.delta))
...
def capture(event):
    cropped.save(OUTPUT_DIR+"/"+imgs[currImage]+"_"+"r_"+str(ratio)+"("+str(master.winfo_pointerx())+", "+str(master.winfo_pointery())+").jpg")
